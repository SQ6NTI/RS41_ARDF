...
//**************config**************
#define CALLSIGN "N0CAL" // unused
#define APRS_CALLSIGN "N0CAL" // APRS callsign without SSID
//#define APRS_CALLSIGN(a,b) a ## b

#define APRS_SSID 0 // APRS SSID
#define APRS_COMMENT "FOX 1" // APRS comment



#define No_Fox	 3	// number of foxes excluding MO
#define Fox 0 // fox number: 0-MOE, 1-MOI, 2-MOS, 3-MOH, 4-MO5, 5-MO, 6..17 (H1..H12) APRS only hunters
